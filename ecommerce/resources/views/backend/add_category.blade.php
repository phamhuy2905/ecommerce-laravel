    ...
    <div class="card-body pt-1">
        <form method="POST" action="{{ route('category.store') }}" id="form" enctype="multipart/form-data">
            ...
            <div class="form-label-group form-group position-relative has-icon-left">
                ...
                <input class="form-control" id="name" placeholder="Category name"  name="name"
                value="{{ old('name') }}">
            ...
            <div class="media-body mt-75">
                ...
                <label for="image" class="btn btn-sm btn-primary ml-50 mb-50 mb-sm-0 cursor-pointer" style="opacity: 1">Category image</label>
                <input class="form-control" id="image" placeholder="Category image"  name="image" type="file" hidden>
                <span class="message_validate text-danger" style="font-size: 12px"></span>
                @if ($errors->has('image'))
