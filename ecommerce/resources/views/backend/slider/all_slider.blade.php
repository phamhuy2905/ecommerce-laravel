...
@if (Session::has('success_delete_slider'))
<div class="d-flex justify-content-end mt-20 toast_message" role="alert" aria-live="assertive" aria-atomic="true">
<div class=" toast d-flex align-items-center text-white bg-success border-0s"
style="opacity: 1 ">
  <div class="toast-body">
    {{ Session::get('success_delete_slider') }}
  </div>
</div>
</div>
@endif
...
<a href="{{ route('slider.create') }}" class="btn btn-info float-right white">Add Slider</a>
                ...
                <tbody>
                    @foreach ($data as $index => $each )
                        <tr>
                            ...
                            <td><a href="{{ route('slider.edit', $each) }}" class="btn btn-primary">Edit</a></td>
                            <td><a href="{{ route('slider.destroy', $each) }}" class="btn btn-danger">Delete</a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
