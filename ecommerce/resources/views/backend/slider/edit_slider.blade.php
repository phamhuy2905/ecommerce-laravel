...
<div class="card-content">
    <div class="card-body pt-1">
        <form method="POST" action="{{ route('slider.update') }}" id="form" enctype="multipart/form-data">
            @csrf
            <input type="text" value="{{ $data->id }}" hidden name="id">
            <input type="text" value="{{ $data->name }}" hidden name="slider_image_old">
            ...
            <div class="media-body mt-75">
                <img src="{{ url($data->image) }}" class="rounded mr-75 border-primary show_img" alt="profile image" height="64" width="64" style="object-fit: cover" class="show_img" id="show_img">
