...
<div class="card-content">
    <div class="card-body pt-1">
        ...
        @endforeach
        <form method="POST" action="{{ route('managerproduct.update') }}" id="form" enctype="multipart/form-data" id="form">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-2">
                            ...
                            <input id="product_size" type="text" class="input-group-lg form-control" name="product_size"  multiple="multiple" 
