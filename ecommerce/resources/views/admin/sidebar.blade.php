...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="{{ route('admin.index') }}"><i class="feather icon-home"></i>
                <span class="menu-title" data-i18n="Dashboard">Home</span></a>
            </li>
            <li class=" nav-item"><a href="{{ route('brand.index') }}"><i class="feather icon-grid"></i><span class="menu-title" data-i18n="Chat">Brand</span> </a>
                <ul class="menu-content">
                    <li><a href="{{ route('brand.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">All brand</span></a>
                    </li>
                    <li><a href="{{ route('brand.create') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Add brand</span></a>
                    </li>
                    
                </ul>
            </li>

            <li class=" nav-item"><a href="{{ route('slider.index') }}"><i class="feather icon-grid"></i><span class="menu-title" data-i18n="Chat">Slider</span> </a>
                <ul class="menu-content">
                    <li><a href="{{ route('slider.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">All slider</span></a>
                    </li>
                    <li><a href="{{ route('slider.create') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Add slider</span></a>
                    </li>
                    
                </ul>
            </li>

            <li class=" nav-item"><a href="{{ route('coupon.index') }}"><i class="feather icon-grid"></i><span class="menu-title" data-i18n="Chat">Coupon</span> </a>
                <ul class="menu-content">
                    <li><a href="{{ route('coupon.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">All coupon</span></a>
                    </li>
                    <li><a href="{{ route('coupon.create') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Add coupon</span></a>
                    </li>
            ...
            <li class=" nav-item"><a href="{{ route('category.index') }}"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Profile">Category</span></a>
                <ul class="menu-content">
                    <li><a href="{{ route('category.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">All Category</span></a>
                    </li>
                    <li><a href="{{ route('category.create') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Add Category</span></a>
                    </li>
                </ul>
            </li>

            <li class=" nav-item"><a href="{{ route('subcategory.index') }}"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Profile">Sub Category</span></a>
                <ul class="menu-content">
                    <li><a href="{{ route('subcategory.index') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">All Sub Category</span></a>
                    </li>
                    <li><a href="{{ route('subcategory.create') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Add Sub Category</span></a>
                    </li>
                </ul>
            </li>

            <li class=" nav-item"><a href="{{ route('managervendor.active') }}"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Profile">Manager Vendor</span></a>
                <ul class="menu-content">
                    <li><a href="{{ route('managervendor.active') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Vendor Active</span></a>
                    </li>
                    <li><a href="{{ route('managervendor.inactive') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Venor Inactive</span></a>
                    </li>
                </ul>
            </li>

            <li class=" nav-item"><a href="{{ route('managerproduct.all') }}"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Profile">Manager Product</span></a>
                <ul class="menu-content">
                    <li><a href="{{ route('managerproduct.all') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">All Product</span></a>
                    </li>
                    <li><a href="{{ route('managerproduct.add') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Add Product</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="{{ route('admin.profile') }}"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Profile">Profile</span></a>
            </li>
