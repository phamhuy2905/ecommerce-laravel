        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item notification"><a class="nav-link nav-link-label"  data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-primary badge-up count">{{$count }}</span></a>
                      
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <div class="dropdown-header m-0 p-2">
                                    <h3 class="white count__title">{{ $count }} New</h3><span class="notification-title">App Notifications</span>
                                </div>
                            </li>
                            <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                                ...
                                <input type="hidden" name="multiple_read_at[]" value="{{ $each->id }}">
                                <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <time class="media-meta" datetime="2015-06-11T18:29:20+08:00">{{ Carbon::parse($each->created_at)->diffForHumans()}} </time></small>
                                </div>
                            </a><a class="d-flex justify-content-between" href="javascript:void(0)">
                                @endforeach
                                <button hidden class="submit">Submit</button>
                            </form>
                                    {{-- <div class="media d-flex align-items-start">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{ auth()->user()->name }}</span><span class="user-status">Hello!</span></div><span><img class="round" src="{{ !empty($data->photo) ? url('img/user_img/'.$data->photo)
                            : url('img/no_img.jpg') }}" alt="avatar" height="40" width="40"></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="page-user-profile.html"><i class="feather icon-user"></i> Edit Profile</a><a class="dropdown-item" href="app-email.html"><i class="feather icon-mail"></i> My Inbox</a><a class="dropdown-item" href="app-todo.html"><i class="feather icon-check-square"></i> Task</a><a class="dropdown-item" href="app-chat.html"><i class="feather icon-message-square"></i> Chats</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href="{{ route('vendor.destroy') }}"><i class="feather icon-power"></i> Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
...
@push('js')
    <script>
        ...
        const count_title = document.querySelector('.count__title')
        function HandelNotification() {
            let isDisplay = true;
            notification.addEventListener('click', function(e) {
                if(isDisplay && count.textContent != 0) {
                    postApi("/form",{1: 'a'}, function(data) {
                    })
                    submit.click()
                    count.textContent = 0;
                    count_title.textContent = 0;
                }
                isDisplay = false;
            })
