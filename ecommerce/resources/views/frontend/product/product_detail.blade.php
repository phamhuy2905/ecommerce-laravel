                ...
                <div class="row mb-50 mt-30">
                    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                        <div class="detail-gallery">
                            ...
                            <div class="product-image-slider">
                                <figure class="border-radius-10">
                                    <img src="{{ url($data->product_thumbnail) }}" alt="product image" class="product_photo" />
                                </figure>
                                <figure class="border-radius-10">
                            ...
                            <div class="slider-nav-thumbnails">
                                ...
                                <div><img src="{{ url($each->photo_name) }}" alt="product image" /></div>
                                @endforeach
                            </div>
                        </div>
                        <!-- End Gallery -->
                        @php
                            ...
                            $percen = $data->discount != NULL ? round($data->discount / $data->price * 100, 2).'%' : 'New';
                        @endphp
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            <span class="stock-status out-stock"> Sale Off </span>
                            <h2 class="title-detail name_product">{{ $data->product_name }}</h2>
                            ...
                            <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    <span class="current-price text-brand product_total">${{ $total }}</span>
                                    <span>
                                        <span class="save-price font-md color3 ml-15">{{ $percen }}</span>
                                        <span class="old-price font-md ml-15 product_price">${{ $data->price }}</span>
                                    </span>
                                </div>
                            </div>

                            <input type="hidden" value="{{ $data->id }}" class="id">
                            <input  value="{{ $data->discount }}" type="hidden" class="product_discount">
                            @csrf
                            ...
                            <div class="attr-detail attr-size mb-30">
                                ...
                                <ul class="list-filter size-filter font-small">
                                    <li><a class="product_size" href="#">{{ $data->size }}</a></li>
                                </ul>
                            </div>
                            <div class="detail-extralink mb-50">
                                <div class="detail-qty border radius">
                                    <a href="#" class="qty-down"><i class="fi-rs-angle-small-down"></i></a>
                                    <input type="text" name="product_quantity" class="qty-val product_quantity" value="1" min="1">
                                    <a href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                </div>
                                <div class="product-extra-link2">
                                    <button type="" class="button button-add-to-cart" onclick="Addcart()"><i
                        ...
                        <div class="row related-products">
                            ...
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap hover-up">
                                    ...
                                    <div class="product-content-wrap">
                                        <h2><a href="shop-product-right.html" tabindex="0">Smart Bluetooth Speaker</a>
                                        </h2>
                                        <div class="rating-result" title="90%">
                                            <span> </span>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-12 col-sm-6 d-lg-block d-none">
                                <div class="product-cart-wrap hover-up mb-0">
                                    ...
                                    <div class="product-content-wrap">
                                        <h2><a href="shop-product-right.html" tabindex="0">Dadua Camera 4K 2022EF</a>
                                        </h2>
                                        <div class="rating-result" title="90%">
                                            <span> </span>
                                        </div>
...
<script> 
        ...
        const product_photo = document.querySelector('.product_photo')
        const quantity = document.querySelector('.product_quantity')
        const name = document.querySelector('.name_product')
        const product_total = document.querySelector('.product_total')
    ...
    function Addcart() {
            ...
            const price_old_value = price.textContent;
            const sale_value = discount.value
            const price_current_value = product_total.textContent
            const img_value = product_photo.getAttribute('src')
            ...
            const data = {
                ...
                name_value,
                sale_value,
                price_current_value: price_current_value.slice(1, price_current_value.length),
                price_old_value: price_old_value.slice(1, price_old_value.length),
                img_value,
                quantity_value,
            }
