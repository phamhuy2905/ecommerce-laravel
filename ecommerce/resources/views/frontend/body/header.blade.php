        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="{{ route('user.index') }}"><img src="{{ asset('frontend/assets/imgs/theme/logo.svg') }}" alt="logo" /></a>
                </div>
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="{{ route('wishlist.show') }}"><span class="lable">Wishlist</span></a>
                            </div>
                            <div class="header-action-icon-2">
                                <a href="{{ route('compare.show') }}">
                                    <i class="fi fi-rs-settings-sliders" style="font-size: 20px"></i>
                                </a>
                                <a href="{{ route('compare.show') }}"><span class="lable">Compare</span></a>
                            </div>
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{ route('cart.all') }}">
                                    <img alt="Nest"
                                        src="{{ asset('frontend/assets/imgs/theme/icons/icon-cart.svg') }}" />
                                    <span class="pro-count blue total_count">0</span>
                                </a>
                                <a href="{{ route('cart.all') }}"><span class="lable ">Cart</span></a>
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    ...
                                    <div class="shopping-cart-footer">
                                        <div class="shopping-cart-total">
                                            <h4 class="cart_total">Total <span>$4000.00</span></h4>
                                        </div>
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('wishlist.show') }}"><i class="fi fi-rs-heart mr-10"></i>My
                                                Wishlist</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <form method="POST" action="{{ route('user.destroy') }}">
                                                @csrf
                                                <span><i class="fi fi-rs-sign-out mr-10"></i>
                                                    <button
                                                        style="border: none; outline:none; background:transparent">Sign
                                                        out</button>
                                                </span>
                                            </form>
                                        </li>
                ...
                <div class="header-nav d-none d-lg-flex">
                    <div class="main-categori-wrap d-none d-lg-block">
                        ...
                        <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                            <div class="d-flex ">
                                <ul>
                                    @foreach ($category->take(5) as $each)
                                    <li>
                                        <a href=""> <img
                                                src="{{ asset( $each->image) }}"
                                                alt="" />{{ $each->name }}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="more_slide_open "  style="display: none">
                                ...
                                <div class="d-flex">
                                    <ul>
                                        @foreach ($category->skip(1)->take(1) as $each)
                                            <li>
                                                <a href="">
                                                    <img src="{{ asset($each->image) }}" alt="" />
                                                    {{ $each->name }}</a>
                                            </li>
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            ...
                            <ul>
                                @foreach ($category as $each)
                                    <li class="">
                                        <a class="" href="index.html">{{ $each->name }} </a>
                                        <a href="#"><i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                            <li >
                                                {{-- <a class="" href="#">{{ $each->name }} </a> --}}
                                                <ul class="">
                                                    @foreach ($subcategory as $sub)
                                                        @if ($sub->category_id == $each->id)
                                                            <li><a href="shop-product-right.html">{{ $sub->name }}</a></li>
                                                        @endif
                                                    @endforeach
                                                </ul>
                                            </li>
