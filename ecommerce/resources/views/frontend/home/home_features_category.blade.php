        ...
        <div class="carausel-10-columns-cover position-relative">
            <div class="carausel-10-columns" id="carausel-10-columns">
                @php
                    ...
                    $brand = Brand::select('brands.id','brands.brand_name','brands.brand_image')
                    ->selectRaw('count(products.brand_id) as count_brand')
                ...
                @foreach ($brand as $each)
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img src="{{ asset( $each->brand_image ) }}" alt="" /></a>
                        </figure>
                        <h6><a href="shop-grid-right.html">{{ $each->brand_name }}k</a></h6>
                        <span>{{ $each->count_brand }}</span>
                    </div>
                @endforeach
