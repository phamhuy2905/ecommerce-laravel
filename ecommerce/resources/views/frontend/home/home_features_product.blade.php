                    ...
                    <div class="tab-pane fade show active" id="tab-one-1" role="tabpanel" aria-labelledby="tab-one-1">
                        <div class="carausel-4-columns-cover arrow-center position-relative">
                            ...
                            @php
                                ...
                                $products = Product::join('users','users.id','products.vendor_id')
                            ...
                            <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                @foreach ($products->take(4) as $each)
                                @php
                                    $total = $each->price - $each->discount;
                                    $percen = $each->discount != NULL ? 'Sale '.round($each->discount / $each->price * 100, 2).'%' : 'New';
                                @endphp
                                    <div class="product-cart-wrap">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="sold mt-15 mb-15">
                                                ...
                                                <span class="font-xs text-heading"> Quantity: {{ $each->product_quantity }}</span>
                                            </div>
