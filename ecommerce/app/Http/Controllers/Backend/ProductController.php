...
class ProductController extends Controller
{
    ...
    public function all() {
        ...
        ->get();
        return view('backend.manager_product.product_all', [
            'data' => $data,
        ]);
    }
    ...
    public function add() {
        ...
        ->get();
        return view('backend.manager_product.product_add', [
            'brand' => $brand,
            'category' => $category,
    ...
    public function process_add(AddProduct $request) {
        ...
        return redirect()->route('managerproduct.all')->with([
    ...
    public function edit(Product $product) {
        ...
        return view('backend.manager_product.product_edit', [
            'brand' => $brand,
            'category' => $category,
            'subcategory' => $subcategory,
            'data' => $product,
    ...
    public function detail($product) {
        ...
        return view('backend.manager_product.product_detail', [
            'data' => $data,
    ...
    public function getApi($product) {
        $data = $this->model
        ->with('category:id,name')
        ->with('subcategory:id,name')
        ->with('brand:id,brand_name')
        ...
        $multiple = MultipeImage::where('product_id', $product)->get();
        $data[] = $multiple;
        return $data;
    }
}
